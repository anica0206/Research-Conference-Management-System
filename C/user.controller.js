...
const uId = require("./login.controller");
    ...
    const exec = conn.query(
      ...
      (err, rows) => {
        ...
        if (err) {
          console.log("sql error happen");
          res.send(
            "<script>alert('Update user account failed');location.href='/B/admin.html';</script>"
          );
        }
            ...
            const exec = conn.query(
              ...
              (err, result) => {
                ...
                if (err) {
                  ...
                  res.send(
                    "<script>alert('Update user account successed');location.href='/B/admin.html';</script>"
                  );
                }
              }
            );
    ...
    const exec = conn.query(
      ...
      (err, rows) => {
        ...
        if (err) {
          console.log("sql error happen");
          res.send(
            "<script>alert('Search user account failed');location.href='/B/admin.html';</script>"
          );
        }
    ...
    const exec = conn.query(
      ...
      (err, result) => {
        ...
        if (err) {
          console.log("sql error happen");
          res.send(
            "<script>alert('Create user profile failed');location.href='/B/admin.html';</script>"
          );
        }
        ...
        if (result) {
          ...
          console.log("inserted success");
          res.send(
            "<script>alert('User profile created!');location.href='/B/admin.html';</script>"
          );
        }
      }
    );
...
const updateUserProfile = (req, res, next) => {
  ...
  pool.getConnection((err, conn) => {
    if (err) {
      conn.release();
      res.send(
        "<script>alert('update user profile failed');location.href='/B/admin.html';</script>"
      );
    }
    ...
    const exec = conn.query(
      ...
      (err, result) => {
        ...
        if (result) {
          ...
          console.log("inserted success");
          res.send(
            "<script>alert('update user profile successed');location.href='/B/admin.html';</script>"
          );
        } else {
    ...
    const exec = conn.query(
      ...
      (err, rows) => {
        ...
        if (err) {
          console.log("sql error happen");
          res.send(
            "<script>alert('search user profile failed');location.href='/B/admin.html';</script>"
          );
        }
